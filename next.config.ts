...
const securityHeaders = [
  ...
  { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.mercadopago.com https://*.mercadolibre.com https://*.mlstatic.com https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://storage.googleapis.com https://cdn.taboola.com https://t.contentsquare.net https://static.cloudflareinsights.com https://www.clarity.ms",
